# TechCareer & PeopleBox Web App Bootcamp Ödevleri

Bu depo, TechCareer & PeopleBox Web App Bootcamp kapsamında yapılan ödevleri içermektedir. Her ödev, ayrı bir klasör içinde bulunmaktadır ve ilgili ödevin adıyla etiketlenmiştir.
